...
echo "Copy Image.............................."
echo " "
cp $IMAGE_DIR/Image $BUILD_IMG/G930F/Image
#########################################################################################
# DT.IMG Generation
...
#echo "Make DT.img............................"
#echo " "
#./tools/dtbtool -o $BUILD_IMG/G930F/dt.img -s 2048 -p ./scripts/dtc/ $DTS/ | sleep 1

#########################################################################################
# Calculate DTS size

#du -k "$BUILD_IMG/G930F/dt.img" | cut -f1 >sizT
#sizT=$(head -n 1 sizT)
#rm -rf sizT
#echo "dt.img: $sizT Kb"
#echo " "
...
# ADB Fix
rm -rf sbin/adbd
cp -r ../G930F/patch/adbd_5.1.1 sbin/adbd

find . | fakeroot cpio -H newc -o | lzop -9 > ../ramdisk.cpio.lzo

cd ..

mv ramdisk.cpio.lzo G930F
...
echo "Make Clean.............................."
echo " "
rm -rf $BUILD_IMG/G930F/Image
rm -rf $BUILD_IMG/G930F/kernel
rm -rf $BUILD_IMG/G930F/ramdisk.cpio.*
rm -rf $BUILD_IMG/G930F/boot.img
#rm -rf $BUILD_IMG/G930F/dt.img
